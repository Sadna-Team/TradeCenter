...
class PurchaseService:
    ...
    def checkout(self, user_id: int, discount_id: int, payment_details: dict, supply_method: str, address: dict, user_info: dict):
        """
            Checkout the shopping cart
        """
        try:
            info = self.__market_facade.checkout(user_id, discount_id, payment_details, supply_method, address, user_info)
