...
class Store:
    ...
    def aquire_products_lock(self, products: List[int]) -> None:
        # to avoid deadlocks, we sort the products by their id
        products.sort()
        for product_id in products:
            self.get_product_by_id(product_id).aquire_lock()
        
    def release_products_lock(self, products: List[int]) -> None:
        # to avoid deadlocks, we sort the products by their id
        products.sort()
        for product_id in products:
